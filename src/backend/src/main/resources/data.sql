...
FROM (
  VALUES
    ...
    ('Gemeinsam Wandern im Park',  'Lockere Wanderung durch den Stadtpark.',
     false, NOW() + INTERVAL '1 day',  52.5200, 13.4050, 180, 250, 831, 40, 'K7M2Q', 10,
     'contact@gotogether.example.com'),
    ('Kaffee & Kunst',             'Gemütliches Treffen mit Galeriebesuch.',
     false, NOW() + INTERVAL '2 day',  52.5150, 13.3880,  90, 150, 412, 30, 'X4P9B',  6,
     'contact@gotogether.example.com'),
    ('Tech Meetup: Programmieren', 'Open-Space Coding Session.',
     false, NOW() + INTERVAL '3 day',  48.8520,  2.3490, 240, 400, 865, 50, 'R3T8N',  0,
     'contact@techcorp.example.com'),

    -- Amberg dataset challenges
    ('Social Raid',
     'Trefft euch am Marktplatz und löst gemeinsam drei kleine Aufgaben.',
     false, TIMESTAMP '2026-06-10 18:30:00', 49.4423, 11.8621,  60, 180, 504, 40, 'H5J1W',  8,
     'community@gotogether-community.example.com'),
    ('Coffee Rush',
     'Vier Personen treffen sich in einem Café und beantworten ein paar lockere Fragen.',
     true,  TIMESTAMP '2026-06-11 16:00:00', 49.4431, 11.8615,  45, 100, 327, 20, 'D9F2L',  4,
     'cafe-central@example.com'),
    ('Sunset Meetup',
     'Trefft euch im Park und schaut gemeinsam den Sonnenuntergang an.',
     false, TIMESTAMP '2026-06-12 20:00:00', 49.4451, 11.8592,  75, 150, 510, 25, 'S6V3Z', 12,
     'community@gotogether-community.example.com'),
    ('Night Walk',
     'Kleine Gruppe für einen ruhigen Abendspaziergang durch die Innenstadt.',
     false, TIMESTAMP '2026-06-13 21:15:00', 49.4417, 11.8635,  60, 120, 393, 10, 'A8Y4C',  7,
     'community@gotogether-community.example.com'),
    ('City Hunt',
     'Löst gemeinsam kleine Aufgaben in der Innenstadt und entdeckt neue Orte.',
     false, TIMESTAMP '2026-06-14 15:30:00', 49.4435, 11.8618, 120, 300, 828, 50, 'M2G7E', 10,
     'community@gotogether-community.example.com'),
    ('Coffee Connect',
     'Vier zufällige Personen treffen sich auf einen Kaffee und reden über einfache Einstiegsthemen.',
     false, TIMESTAMP '2026-06-15 17:00:00', 49.4440, 11.8601,  45, 100, 335, 30, 'B1U6Q',  4,
     'cafe-zentral@example.com'),
    ('Park Games',
     'Trefft euch im Park für kleine Gruppenspiele und lockere Team-Aufgaben.',
     false, TIMESTAMP '2026-06-16 18:45:00', 49.4462, 11.8587,  90, 280, 799, 60, 'N9K3T', 14,
     'community@gotogether-community.example.com'),
    ('Food Spot Tour',
     'Gemeinsam verschiedene kleine Food-Spots in der Stadt ausprobieren.',
     false, TIMESTAMP '2026-06-17 19:00:00', 49.4429, 11.8610, 150, 350, 1041, 50, 'P4W8H', 10,
     'community@gotogether-community.example.com'),
    ('Photo Mission',
     'Macht gemeinsam kreative Bilder an verschiedenen Orten in der Stadt.',
     false, TIMESTAMP '2026-06-18 16:30:00', 49.4438, 11.8627, 120, 200, 531, 35, 'C7R2X',  8,
     'community@gotogether-community.example.com'),
    ('Late Night Talk',
     'Lockeres Gruppentreffen am Abend. Einfach zusammensitzen und reden.',
     false, TIMESTAMP '2026-06-19 22:00:00', 49.4408, 11.8641,  90, 130, 417, 20, 'F5L9D',  9,
     'community@gotogether-community.example.com'),
    ('River Walk',
     'Gemeinsamer Spaziergang entlang der Vils mit kleinen Gesprächsimpulsen.',
     false, TIMESTAMP '2026-06-20 18:00:00', 49.4412, 11.8650,  75, 150, 499, 30, 'T3Z6V',  9,
     'community@gotogether-community.example.com'),
    ('Castle Team Quest',
     'Trefft euch an der Burg und löst gemeinsam kleine Team-Aufgaben.',
     false, TIMESTAMP '2026-06-21 17:30:00', 49.4448, 11.8582, 120, 320, 871, 55, 'Y1A8M', 12,
     'community@gotogether-community.example.com'),
    ('Music Meetup',
     'Bringt eure Lieblingssongs mit und lernt neue Leute über Musik kennen.',
     false, TIMESTAMP '2026-06-22 19:00:00', 49.4460, 11.8594, 120, 250, 721, 40, 'Q2J7G', 10,
     'community@gotogether-community.example.com'),
    ('Street Quiz',
     'Kleine Gruppen treten gegeneinander in einem Stadt-Quiz an.',
     false, TIMESTAMP '2026-06-23 16:30:00', 49.4423, 11.8621,  60, 200, 579, 45, 'E9N4B', 14,
     'community@gotogether-community.example.com'),
    ('Morning Coffee Circle',
     'Lockeres Frühstückstreffen für alle, die morgens neue Leute kennenlernen möchten.',
     false, TIMESTAMP '2026-06-24 09:00:00', 49.4439, 11.8604,  60,  80, 315, 15, 'U6K1S',  6,
     'cafe-zentral@example.com'),
    ('Team Picnic',
     'Gemeinsames Picknick mit kleinen Gruppenspielen im Park.',
     false, TIMESTAMP '2026-06-25 18:15:00', 49.4454, 11.8589, 180, 380, 1229, 50, 'W3P8R', 15,
     'community@gotogether-community.example.com'),
    ('Hidden Spots',
     'Entdeckt gemeinsam unbekannte Orte in der Altstadt.',
     false, TIMESTAMP '2026-06-26 17:45:00', 49.4433, 11.8616, 120, 250, 621, 40, 'H7C2L',  8,
     'community@gotogether-community.example.com'),
    ('Board Game Evening',
     'Spieleabend mit kleinen Teams und wechselnden Gruppen.',
     false, TIMESTAMP '2026-06-27 19:30:00', 49.4404, 11.8673, 180, 220, 808, 25, 'X4D9F', 16,
     'klaerwerk@example.com'),
    ('Sunrise Challenge',
     'Frühes Treffen mit kleiner Gruppe zum Sonnenaufgang.',
     false, TIMESTAMP '2026-06-28 05:15:00', 49.4386, 11.8724,  90, 110, 339, 0, 'V5M3T',  7,
     'community@gotogether-community.example.com'),
    ('Weekend Social Raid',
     'Große Gruppenquest am Wochenende mit mehreren Mini-Challenges in der Innenstadt.',
     false, TIMESTAMP '2026-06-29 14:00:00', 49.4428, 11.8617, 300, 600, 2314, 70, 'G8Z1Q', 20,
     'community@gotogether-community.example.com')
